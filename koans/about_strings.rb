...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    #
    # Answer: 
    # in all likelihood, because the += requires a temporary/local variable
    # whereas the shovel operator can just build up a single variable.
  end
  ...
  # I'm assuming that string[7,3] means:
  # "Take a substring of string starting at index 7 and grab 
  # 3 characters"
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    #
    # Answer:
    # not really, it looks like this is an index call...
  end
